 ...
 */
@ParameterResolver
public class ResponseParamResolver implements ParameterValueResolver<Response> {
    @Override
    public Response getValue(Response response, Request request, MethodParam methodParam) {
        return response;
    }
}
