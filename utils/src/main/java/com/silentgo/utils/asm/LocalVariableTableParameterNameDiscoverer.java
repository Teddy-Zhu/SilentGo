...
public class LocalVariableTableParameterNameDiscoverer {
    ...
    private Map<Member, String[]> inspectClass(Class<?> clazz) {
        ...
        if (is == null) {
            ...
            logger.debug("Cannot find '.class' file for class {} - unable to determine constructors/methods parameter names", clazz);
        ...
        try {
            ...
            logger.debug("Exception thrown while reading '.class' file for class {} - unable to determine constructors/methods parameter names", clazz);

        } catch (IllegalArgumentException ex) {
            logger.debug("ASM ClassReader failed to parse class file {}, probably due to a new Java class file version that isn't supported yet " +
                    "- unable to determine constructors/methods parameter names", clazz);
