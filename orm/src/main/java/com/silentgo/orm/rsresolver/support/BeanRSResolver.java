 ...
 */
public class BeanRSResolver<T> implements OneRowRSResolver<T> {
    ...
    public BeanRSResolver(Class<T> clz) {
        this(clz, new HashMap<String, String>());
    }

    public BeanRSResolver(Class<T> clz, Map<String, String> columnToPropertyOverrides) {
        super();
        if (clz == null) {
